...
import { createForexPair } from 'apiSdk/forex-pairs';
...
function ForexPairCreatePage() {
  ...
  const formik = useFormik<ForexPairInterface>({
    initialValues: {
      pair_name: '',
      broker_id: (router.query.broker_id as string) ?? null,
    },
